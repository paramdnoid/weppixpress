<template>
  ...
  >
    <a
      href="#"
      class="nav-link d-flex lh-1 p-0 ps-2"
    ...
    >
      ...
      <div class="d-none d-md-block ps-2 text-truncate user-info-truncate">
        ...
        <div
          class="mt-1 small text-truncate w-auto overflow-hidden lh-xs"
          style="color: var(--tblr-gray-300);padding-right: 3px;"
        >{{ user?.email }}
        </div>
      </div>
    </a>
    ...
    <div
      v-if="showConfirm"
      class="modal d-block modal-backdrop"
      tabindex="-1"
      data-bs-theme="light"
    >
