        ...
        <div class="modal-header">
          <h5 class="modal-title">
            <svg
              ...
              class="icon icon-tabler icon-tabler-settings me-2"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              stroke-width="2"
          ...
          >
            <div class="d-flex gap-2">
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-player-pause me-2"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  stroke-width="2"
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-player-play me-2"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  stroke-width="2"
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="icon icon-tabler icon-tabler-trash me-2"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                  stroke-width="2"
